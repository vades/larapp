...
<div x-show="showModal"
     id="modalWindow"
        {{$attributes->class(['hidden fixed z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 modal'])}}>
    <div class="relative top-10 mx-auto max-w-[1800px] shadow-xl bg-white h-[90%]">
        ...
        @isset($footer)
            ...
            <footer class="flex items-center p-4 md:p-5 border-t border-gray-200  dark:border-gray-600 bg-white">
                {{$footer}}
            </footer>
        @endisset
    </div>
