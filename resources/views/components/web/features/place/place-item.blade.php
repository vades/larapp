<x-web.layout :title="$page->metaTitle"
    ...
    <x-web.features.place.partials.place-item-header :place="$place" class="mb-8 text-skin-place" />
    @if(isset($images))
   ...
   {{--  <x-web.features.place.partials.place-item-gallery :images="$images" class="mb-8" /> --}}
    ...
    <x-web.features.place.partials.place-item-related :related="$related" class="mb-8 text-skin-place" />
    @endif
