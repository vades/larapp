        ...
        extend: {
            textColor: {
                skin: {
                    ...
                    'supplementary': 'var(--color-text-supplementary)',
                    'supplementary-muted': 'var(--color-text-supplementary-muted)',
            ...
            backgroundColor: {
                skin: {
                    ...
                    'supplementary': 'var(--color-bg-supplementary)',
            ...
            borderColor: {
                skin: {
                    ...
                    'supplementary': 'var(--color-border-supplementary)',
